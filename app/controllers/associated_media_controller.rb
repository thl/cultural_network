class AssociatedMediaController < ApplicationController
  ...
  def pictures
    @media = MmsIntegration::Topic.paginated_media(@feature.fid, 'pictures', page: params[:page], :per_page => params[:per_page])
  ...
  # GET /topics/1/videos
  def videos
    @media = MmsIntegration::Topic.paginated_media(@feature.fid, 'videos', page: params[:page], :per_page => params[:per_page])
  ...
  def documents
    @media = MmsIntegration::Topic.paginated_media(@feature.fid, 'documents', page: params[:page], :per_page => params[:per_page])
