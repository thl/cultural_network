...
class SummariesControllerTest < ActionController::TestCase
  ...
  test "should create summary" do
    assert_difference('Summary.count') do
      post :create, :summary => { :author_id => @summary.author_id, :content => @summary.content, :feature_id => @summary.feature_id, :language_id => @summary.language_id }
    end
  ...
  test "should update summary" do
    put :update, :id => @summary, :summary => { :author_id => @summary.author_id, :content => @summary.content, :feature_id => @summary.feature_id, :language_id => @summary.language_id }
    assert_redirected_to summary_path(assigns(:summary))
  end
